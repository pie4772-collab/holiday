              ...
              {group.employees.map((emp) => (
                <div key={emp.id} className="mobile-card-item">
                  ...
                  <div className="grid grid-cols-3 gap-2 mt-3 text-center">
                    ...
                    <div>
                      <p className="mobile-card-label">당월사용</p>
                ...
                <tbody>
                  {group.employees.map((emp) => (
                    <tr key={emp.id}>
                      ...
                      <td className="tabular-nums">{emp.accrued}</td>
                      <td className="tabular-nums">{emp.usedInMonth}</td>
                      <td className="tabular-nums font-medium text-[#09825d]">{emp.remaining}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
